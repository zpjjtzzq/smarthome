...
public class GetWeiBoEvent {
    ...
    public void getWeiBoEvent(){
        ...
        if (is_valid(mAccessToken)){
            ...
            Log.i("weibo_access", "access to WeiBo");
            ...
            Log.i("weibo_access", "fail to access to WeiBo");
        }
                    ...
                    for (int i = 0; i < 1; i++) {
                        ...
                        if (id <= latestId){
                            ...
                            if (results.size() > 0) {
                                ...
                                socialSource.setSourceTypeId(3);
                                socialInfo.setActivityRecordTime(socialInfo.getActivitySentTime());
                                socialInfo.setStartTime(result[1]+".123");
                                Log.i("start_time", result[1]);
