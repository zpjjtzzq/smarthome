...
import com.example.smarthomeapp.adapter.AirconditionerFragmentAdapt;
...
public class AirconditionerFrgament extends Fragment{
    ...
    HttpResultProcessListener httpResultProcessListener = new HttpResultProcessListener() {
        ...
        public void processing(int status, String responsString) {
            ...
            airconditionerFragmentAdapt.setAirConditionStatusArray(airConditionStatuses);
            airconditionerFragmentAdapt.notifyDataSetChanged();
        }
    };
    Activity activity;
    HashSet<Integer> ids;
    ...
    AirconditionerFragmentAdapt airconditionerFragmentAdapt;
...
//        airConditionStatuses[1]=airConditionStatus;
    ...
    public void onResume() {
       ...
       // timer.schedule(task,2000,10000);
        ...
        airconditionerFragmentAdapt =new AirconditionerFragmentAdapt(this.getActivity(),null,new boolean[]{true,true});
        expandableListView.setAdapter(airconditionerFragmentAdapt);
