...
public class AirconditionerFragmentAdapt extends BaseExpandableListAdapter {
    ...
    private AirconditionerFragmentAdapt airconditionerFragmentAdapt =this;
    ...
    public AirconditionerFragmentAdapt(Context context, AirConditionStatus[] airConditionStatusArray, boolean[] isON) {
