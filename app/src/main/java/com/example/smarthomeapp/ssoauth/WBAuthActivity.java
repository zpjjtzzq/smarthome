 ...
 */
//
//sso授权+sso(ALL IN ONE)授权
//
package com.example.smarthomeapp.ssoauth;
...
public class WBAuthActivity extends Activity {
    ...
    //public static String TransAccessToken="2.00Eind1CnFykyD2f1e266745BG2d3B";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAccessToken.isSessionValid()) {
        	//TransAccessToken=mAccessToken.getToken();//
    ...
    //按下返回键返回到主程序WBStatusAPIActivity  2015-6-28-14:31
    public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
			Intent intent = new Intent();
            intent.setClass(this, UIMainActivity.class);
            intent.putExtra("ToolsFragment",1);
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
          ...
          //从这里获取用户输入的 电话号码信息 
            ...
            if (mAccessToken.isSessionValid()) {
            	//TransAccessToken=mAccessToken.getToken();//2015-6-18-14:46 add
